...
<div class ="container-fluid foo-ter">
    ...
    <ul class ="foo-li"style="list-style-type:none">
            <li><i class="fa fa-map-marker" style="font-size: 15px;color:red;text-decoration:none;"><a style="font-family: 'Jura', sans-serif;color:#fff;"> NIT Jamshedpur</a></i></li>&nbsp;&nbsp;
            <li><a class="fa fa-envelope" style="font-size: 16px;color:red;"><a class="text-light" style="font-family: 'Jura', sans-serif;color:#fff;text-decoration:none;" href="mailto:ojass@nitjsr.ac.in"> ojass@nitjsr.ac.in</a> </i></li>
          </ul>
          <center>
